...
{
    public sealed record Query(Guid ProfileId) : ICustomQuery<List<BookProgress>>;

    internal class Handler(IDbContextFactory<DatabaseContext> dbContextFactory) : ICustomQueryHandler<Query, List<BookProgress>>
    {
