...
public static class BookExtensions
{
    ...
    {
        return book.Progresses.Any(x => x.ElapsedTime != TimeSpan.Zero);
    }
    ...
    {
        return books.Where(b => b.IsStartedReading() && !b.IsFinishedReading()).ToList();
    }
    
    public static bool AnyReading(this IEnumerable<Book> books)
    {
        return books.Any(b => b.IsStartedReading() && !b.IsFinishedReading());
    }
}